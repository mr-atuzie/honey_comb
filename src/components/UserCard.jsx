  ...
  return (
    <div className=" bg-white shadow-lg  px-4 py-6 lg:p-8 rounded h-fit mb-10">
      <div className=" mb-4 flex justify-between items-center">
        ...
        <div className="bg-black text-white  p-1 h-fit rounded-full">
          <BsEyeSlash size={15} />
        </div>
      </div>

      <div className=" mt-8 flex gap-4 ">
        <button className=" text-white bg-black   py-2 lg:py-3 text-center font-medium rounded-lg text-sm px-4 lg:px-8">
          Invest
        </button>
        <button className="text-white bg-black   py-2 lg:py-3 text-center font-medium rounded-lg text-sm px-4 lg:px-8">
          Withdraw
